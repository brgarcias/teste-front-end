		...
		$.getJSON(flickerAPI, {
			...
			.done(function (data) {
				for (i = 0; i < data.products.length; i++) {
					...
					produtosJson += '<button data-izimodal-open="#modal' + i + '" data-izimodal-transitionin="fadeInDown" class="trigger action action--button action--buy"><i class="fa fa-search"></i><span class="action__text">Ver detalhes</span></button></div><label class="action action--compare-add"><input class="check-hidden" type="checkbox" /><i class="fa fa-plus"></i><i class="fa fa-check"></i><span class="action__text action__text--invisible">Clique para comparar</span></label></div>';
				}
